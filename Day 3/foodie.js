...
faveFoods.breakfast = "cigarettes 🚬 & coffee ☕";
faveFoods.lunch = "pasta carbonara 🍝";
faveFoods.supper = "indian butter chicken 🍛";

const breakfast = faveFoods.breakfast;
const lunch = faveFoods.lunch;
const supper = faveFoods.supper;

document.getElementById('meals').innerHTML = `For breakfast, I only like ${breakfast}. 
